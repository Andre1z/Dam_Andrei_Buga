    ...
    <div class="contenedor">
        ...
        <section>
            <article id="post">
                ...
                <p>Esta aplicación de palegreen esta hecha en html, esta aplicacion de palegreen es una demostración de controles interactivos en formularios web utilizando HTML, CSS, JavaScript. Se incorporan los siguientes comonientes: 1.- Firma digital, permite al usuario dibujar su firma mediante un canvas y el trazo se captura en formato Base64 y se almacena en un campo oculto. 2.- Selector de Coordenadas Geograficas: Utiliza Leaflet y OpnStreetMap para mostrar un mapa interactivo, el usuario puede seleccionar una ubicación en el mapa; la coordenada se guarda en un input oculto y la selección se visualiza en un modal que se abre al pulsar el botón correspondiente. 3.- Selector de Color de Paleta Personalizada: Despliega una paleta de 140 colores CSS3 para que el usuario pueda elegir un color y al seleccionar un color, se actualiza el campo y se muestra el color seleccionado. Tambien podemos generar y descargar un JSON, al enviar el formulario, se genera automaticamente el archivo "datos.json" que contiene los datos de la firma, las coordenada y el color seleccionado. Este archivo se descarga al equipo el usuario. Cuando tengamos ese JSON, tambien podemos cargarlo nuevamente, al seleccionalo, se leen sus datos y se actualizan los controles del formulario. La descarga y la carga del archivo JSON se realiza en el navegador. Todos los codigos estan bien comentados y estructurados. </p>
